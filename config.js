...
export const DOMAIN = 'https://www.mangatoons.online';
export const BACKEND_DOMAIN = 'https://backend-mangawebsite.vercel.app'



export const DOMAIN_NAME = 'mangatoons.online';
export const IMAGES_SUBDOMAIN = "https://images.mangatoons.online";
export const DISQUS_SHORTNAME = "my-cms-7";


export const APP_NAME = 'Manga Toons';
export const NavbarName = "Manga Toons";
